        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-10 border-t border-white/10 text-white">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center space-x-4 pt-1.5 text-white">
              ...
              {/* Instagram */}
              <Link href="https://www.instagram.com/azusahotelandapartments/" className="p-2.5 bg-white/5 border border-white/10 rounded-full hover:bg-amber-800 hover:border-white transition-all text-white" aria-label="Instagram">
              ...
              {/* Facebook */}
              <Link href="https://www.facebook.com/people/Azusa-Hotels-and-Apartments/61584264591441/" className="p-2.5 bg-white/5 border border-white/10 rounded-full hover:bg-amber-800 hover:border-white transition-all text-white" aria-label="Facebook">
